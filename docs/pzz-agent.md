...
```dotenv
PZZ_MCP_SERVER=http://10.32.1.46:8765/mcp
...
These fields go directly to PZZ and are not generated by the planner. PZZ events
are wrapped in `step_event`; a clarification stops dependent steps.
