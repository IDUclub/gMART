...
Токен так и не был обновлён в течение отведённого времени (60 секунд). Пайплайн сохранил чекпоинт и завершил работу. SSE-поток закрывается.
...
Если токен не был обновлён вовремя (> 60 сек):
