    ...
    for extension in ENV_EXTENSIONS:
        if try_load(extension):
            return AgentsAppConfig(
                ...
                genplanner_mcp_url=os.getenv("GENPLANNER_MCP_SERVER"),
                genbuilder_mcp_url=os.getenv("GENBUILDER_MCP_SERVER"),
                pzz_mcp_url=os.getenv("PZZ_MCP_SERVER"),
                pzz_api_url=os.getenv("PZZ_API_URL"),
