...
AGENT_CATALOG: dict[OrchestratorAgent, AgentCatalogEntry] = {
    OrchestratorAgent.RESTRICTION: AgentCatalogEntry(
        ...
        description=(
            ...
            "нарушений у конкретных объектов используй compliance."
        ),
        examples=(
    ...
    OrchestratorAgent.COMPLIANCE: AgentCatalogEntry(
        ...
        description=(
            ...
            "нарушают отступ», «найди объекты, пересекающие зону»."
        ),
        examples=(
    ...
    OrchestratorAgent.SCENARIO_DATA: AgentCatalogEntry(
        ...
        description=(
            ...
            "показатели и сравнивает явно указанные сценарии. Расчёт дефицита "
            "обеспеченности выполняет provision."
        ),
        examples=(
