...
его повторно и не пиши его номер в task: пользователь видит task в плане. Явные ID
сравниваемых сценариев, названные пользователем, сохраняй в task. Не выдумывай ID,
объекты, нормы или числа результатов.
