...
class NormsQaRequestDTO(SimpleRequestDTO):
    """
    DTO for the normative-restrictions QA endpoint.

    The agent queries the NormGraph restriction graph and answers the natural-language
    question; scenario_id / chat_id are optional and used for chat-history persistence.
    Attributes:
