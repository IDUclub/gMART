...
@urban_api_mcp.tool(
    ...
    description=(
        ...
        "Сопоставляет падежные формы и множественное число с точными названиями "
        "справочника по начальным формам слов, сохраняя все уточнения. "
        "Возвращает canonical_name и type_id только при однозначном совпадении."
    ),
    tags=tools_tags,
